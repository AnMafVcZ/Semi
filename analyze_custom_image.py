#!/usr/bin/env python3
"""
Analyze custom image with detailed visualization and statistics
"""
...
def analyze_custom_image(image_path):
    """Analyze a custom image with detailed visualization"""
    
    if not os.path.exists(image_path):
        print(f"Error: Image file not found: {image_path}")
        return
    
    print(f"Analyzing custom image: {image_path}")
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python3 analyze_custom_image.py <image_path>")
        print("Example: python3 analyze_custom_image.py my_wafer_image.jpg")
        sys.exit(1)
